...
class RealtimeAgentGradioInterface:
    def __init__(self):
        ...
        self.agent = RealtimeAgentMultiprocessing(
            ...
            output_sequence_max_length=1000
        )
    ...
    def execute(self, state, audio, tts_buffer_size, asr_buffer_size, asr_model_size, 
        ...
        agent_config = RealtimeAgentConfig(identities={
    ...
    def launch(self):
        ...
        asr_logprob_threshold_slider = gr.inputs.Slider(minimum=-3.0, maximum=0.0, default=-0.4, label="ASR Log prob threshold")
        asr_no_speech_threshold_slider = gr.inputs.Slider(minimum=0.0, maximum=1.0, default=0.3, label="ASR No speech threshold")
