# ---------------------------------------------------------------------------------------------------
# This file was taken directly from https://github.com/yxuansu/SimCTG/blob/main/simctg/evaluation.py
# Copied for now due to issues with pip install of the `simctg` package.
# ---------------------------------------------------------------------------------------------------
